...
public class DeliveryManJPanel extends javax.swing.JPanel {
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        system.getUserAccountDirectory().createUserAccount(username, password, emp, new DeliverManRole());

        JOptionPane.showMessageDialog(this, "Succesful! Enter Deliveryman details!");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        DeliveryMan del = deliverymanlist.addNewDeliveryMan();
        del.setId(txtUsername.getText());
    ...
    private void tblViewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblViewMouseClicked
        ...
        for(DeliveryMan del: deliverymanlist.getDeliverymanlist()){

            if(id.equals(del.getId())){
                txtUpdateName.setText(del.getName());
                
                
                txtUpdatePhno.setText(del.getPhno());
            }
        }
    ...
    private void btnSave1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSave1ActionPerformed
        ...
        for(DeliveryMan deli: deliverymanlist.getDeliverymanlist()){

            if(id.equals(deli.getId())){

                deli.setName(name);
                
                
                deli.setPhno(phno);
                JOptionPane.showMessageDialog(this, "DeliveryMan updated!");
                break;
    ...
    private void tblView1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblView1MouseClicked
        ...
        for(DeliveryMan deli: deliverymanlist.getDeliverymanlist()){
            ...
            if(id.equals(deli.getId())){
                txtUpdateName1.setText(deli.getName());
                
              
                txtUpdatePhno1.setText(deli.getPhno());
            }
        }
